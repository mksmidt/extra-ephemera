...
App devs - very specific, business focused; organized around business functionality


System programmers - very general purpose - operating systems, databases, network protocols, etc.
...
Unit tests at the very minimum CANNOT access:
    - the file system
    - databases
    - network
    - the clock
...
WHY?
    - They are EXTERNAL. Any failures in testing may be because of these things instead of your code.
